...
**5 Bücher** (Selbsthilfe/emotionale Gesundheit, über Amazon KDP als Taschenbuch + Kindle-E-Book):

1. **„Ich stand nie auf meiner eigenen Liste"** — für Menschen, die jahrelang für alle anderen funktionieren, sich selbst dabei immer weiter hinten anstellen und irgendwann merken, dass sie im eigenen Leben kaum noch vorkommen. *(Fokusbuch, aktueller Haupttreiber.)*
...
Getrennte Kanäle für Bücher und andere Geschäftsbereiche.

- **Bücher:** Instagram, TikTok, Facebook, Telegram „Petra Tanner – Worte mit Wirkung", Newsletter über Tentary (Bonus-PDFs + automatisierte Willkommensserie)
- **Mentoring/andere Bereiche:** eigene Kanäle, hier noch nicht erfasst

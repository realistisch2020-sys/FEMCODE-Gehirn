# Human Design Chart – Brigitte Bänziger
### Schwerpunkt: Körper & Ernährung

**Geburtsdaten:** 17.07.1962, 15:25 Uhr, Zürich (Schweiz, damals ganzjährig MEZ, keine Sommerzeit)
...
|---|---|
| **Typ** | Generator |
| **Autorität** | Emotionale Autorität (Solarplexus) |
| **Profil** | 5/1 – "Ketzer/Häretiker" |
| **Definition** | Split (zwei getrennte Bereiche) |
...
Definierte Kanäle: 6–59 (Sakral–Solarplexus), 13–33 (G-Zentrum–Kehle), 39–55 (Wurzel–Solarplexus)
